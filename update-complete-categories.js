...
try {
  ...
  console.log("📝 Inserting comprehensive category data...");

  // Main categories with complete data
  ...
  // Laptop brands (children of "Laptop Theo Hãng")
  const laptopBrands = [
    {
      id: 20,
      name: "Laptop ASUS",
  ...
  // Laptop by usage (children of "Laptop Theo Nhu Cầu")
  const laptopUsage = [
    {
      id: 30,
      name: "Laptop Gaming",
  ...
  const phoneSubcategories = [
    {
      ...
      name: "iPhone",
      slug: "iphone",
      description: "iPhone 15 series với chip A17 Pro mới nhất",
      image:
  ...
  console.log(`\n🎉 Successfully added ${allCategories.length} categories!`);
  ...
  console.log(`   Main categories: ${summary.main_categories}`);
