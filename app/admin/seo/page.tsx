            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("general", "site_url", e.target.value)
                    }
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm text-muted-foreground">
                  <span>
                    {settings.general.site_description.length}/160 ký tự
                  </span>
                  <Badge
                    variant={
                      settings.general.site_description.length <= 160
                        ? "default"
                        : "destructive"
                    }
                  >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateSetting("general", "site_keywords", e.target.value)
                  }
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center space-x-2 mb-6">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateSetting("analytics", "enable_analytics", checked)
                  }
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="gsc_verification"
                    value={
                      settings.analytics.google_search_console_verification
                    }
                    onChange={(e) =>
                      updateSetting(
                        "analytics",
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("analytics", "hotjar_id", e.target.value)
                    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("social", "facebook_app_id", e.target.value)
                    }
                    placeholder="facd"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("social", "twitter_site", e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("social", "tiktok_url", e.target.value)
                    }
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSetting("schema", "enable_product_schema", checked)
                    }
                  />
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSetting("technical", "enable_sitemap", checked)
                    }
                  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateSetting("technical", "minify_html", checked)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateSetting("technical", "lazy_load_images", checked)
                      }
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateSetting("content", "enable_auto_seo", checked)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateSetting("content", "h1_optimization", checked)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateSetting("content", "internal_linking", checked)
                      }
                    />
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSetting("content", "enable_faq_schema", checked)
                    }
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSetting("content", "enable_article_schema", checked)
                    }
                  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateSetting("performance", "optimize_images", checked)
                      }
                    />
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateSetting("performance", "enable_cdn", checked)
                    }
                  />
                ...
                {settings.performance.enable_cdn && (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSetting("performance", "cdn_url", e.target.value)
                      }
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center space-x-2 mb-6">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateSetting("local", "enable_local_seo", checked)
                  }
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateSetting("local", "opening_hours", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="service_areas"
                  value={
                    Array.isArray(settings.local.service_areas)
                      ? settings.local.service_areas.join(", ")
                      : settings.local.service_areas
                  }
                  onChange={(e) =>
                    updateSetting(
                      "local",
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateSetting("local", "enable_review_schema", checked)
                  }
                />
