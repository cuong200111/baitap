...
async function createSeoTables() {
  try {
    ...
    const defaultSettings = [
      ...
      [1, 'site_name', 'ZoxVN- Máy tính, Laptop', 'general', 'Tên website chính', 1],
      [2, 'site_url', 'https://hacom.vns', 'general', 'URL chính của website', 1],
      [3, 'site_description', 'HACOM - Chuyên cung cấp máy tính, laptop, linh kiện máy tính, gaming gear với giá tốt nhất. Bảo hành chính hãng, giao hàng toàn quốc.', 'general', 'Mô tả website', 1],
      [4, 'site_keywords', 'máy tính, laptop, gaming, linh kiện máy tính, PC, HACOM', 'general', 'Từ khóa chính', 1],
      [5, 'site_logo', '/logo.png', 'general', 'Logo website', 1],
      [6, 'site_favicon', '/favicon.ico', 'general', 'Favicon', 1],
      [7, 'default_meta_title_pattern', '{title} | HACOM', 'general', 'Pattern cho meta title mặc định', 1],
      [8, 'auto_generate_meta_description', '1', 'general', 'Tự động tạo meta description', 1],
      [9, 'meta_description_length', '160', 'general', 'Độ dài tối đa meta description', 1],
      [38, 'product_meta_title_pattern', '{product_name} - {category} | HACOM', 'general', NULL, 1],
      [39, 'category_meta_title_pattern', '{category_name} - {description} | HACOM', 'general', NULL, 1],
      ...
      [12, 'default_og_image', '/og-image.jpg', 'social', 'Open Graph image mặc định', 1],
      ...
      [14, 'google_tag_manager_id', '', 'analytics', 'Google Tag Manager ID', 1],
      [15, 'google_search_console_verification', '', 'analytics', 'Google Search Console verification', 1],
      ...
      [19, 'organization_address', 'Số 131 Lê Thanh Nghị, Hai Bà Trưng, Hà Nội', 'schema', 'Địa chỉ tổ chức', 1],
      [20, 'organization_phone', '1900 1903', 'schema', 'Số điện thoại', 1],
      [21, 'organization_email', 'contact@hacom.vn', 'schema', 'Email liên hệ', 1],
      [22, 'business_type', 'ElectronicsStore', 'schema', 'Loại hình kinh doanh', 1],
      [23, 'enable_organization_schema', '1', 'schema', 'Bật Organization Schema', 1],
      ...
      [25, 'sitemap_max_urls', '50000', 'technical', 'Số URL tối đa trong sitemap', 1],
      ...
      [100, 'opening_hours', 'Thứ 2 - Chủ nhật: 8:00 - 22:00', 'local', NULL, 1],
    ...
    for (const [id, key, value, category, description, is_active] of defaultSettings) {
      await executeQuery(
        `
    ...
    console.log("🎉 SEO tables migration completed successfully with ALL user's SQL settings!");
  } catch (error) {
