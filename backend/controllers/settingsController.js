    ...
    try {
      ...
      if (Array.isArray(settings)) {
        settings.forEach((setting) => {
          ...
          if (key.startsWith('store_') || key.startsWith('shop_')) {
            ...
            category = 'payment';
          } else if (key.startsWith('email_') || key.startsWith('smtp_') || key.startsWith('mail_')) {
            category = 'email';
          } else if (key.startsWith('security_') || key.startsWith('auth_')) {
            category = 'security';
          } else if (key.startsWith('notification_') || key.startsWith('alert_')) {
          ...
          const cleanKey = key.replace(/^(store_|shop_|shipping_|delivery_|payment_|pay_|email_|smtp_|mail_|security_|auth_|notification_|alert_)/, '');
      ...
      const defaultSettings = {
        general: {
          ...
          site_description: "Chuyên cung cấp laptop, PC gaming và linh kiện máy tính",
