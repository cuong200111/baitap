...
export const searchController = {
  ...
  async search(req, res) {
    try {
      ...
      if (min_price) {
        whereConditions.push(
          "(products.sale_price >= ? OR (products.sale_price IS NULL AND products.price >= ?))",
        );
    ...
    try {
      ...
      if (type === "provinces") {
        const provinces = [
          { code: 1, name: "Hà Nội", full_name: "Thành phố Hà Nội" },
          {
            code: 79,
            name: "TP Hồ Chí Minh",
            full_name: "Thành phố H��� Chí Minh",
          },
      ...
      if (type === "districts" && province_code) {
        ...
        const districts = districtsData[province_code] || [
          ...
          {
            code: parseInt(province_code) * 1000 + 1,
            name: "Huyện 1",
            full_name: "Huyện 1",
            province_code: parseInt(province_code),
          },
          {
            code: parseInt(province_code) * 1000 + 2,
            name: "Huyện 2",
            full_name: "Huyện 2",
            province_code: parseInt(province_code),
          },
          {
            code: parseInt(province_code) * 1000 + 3,
            name: "Huyện 3",
            full_name: "Huyện 3",
            province_code: parseInt(province_code),
          },
          {
            code: parseInt(province_code) * 1000 + 4,
            name: "Huyện 4",
            full_name: "Huyện 4",
            province_code: parseInt(province_code),
          },
          {
            code: parseInt(province_code) * 1000 + 5,
            name: "Huyện 5",
            full_name: "Huyện 5",
            province_code: parseInt(province_code),
          },
        ...
        const wardsData = {
          ...
          2: [
            // Hoàn Kiếm
            {
              code: 37,
              name: "Phúc Tân",
              full_name: "Phường Phúc Tân",
              district_code: 2,
            },
            {
              code: 40,
              name: "Đồng Xuân",
              full_name: "Phường Đồng Xuân",
              district_code: 2,
            },
            {
              code: 43,
              name: "Hàng Mã",
              full_name: "Phường Hàng Mã",
              district_code: 2,
            },
            {
              code: 46,
              name: "Hàng Buồm",
              full_name: "Phường Hàng Buồm",
              district_code: 2,
            },
            {
              code: 49,
              name: "Hàng Đào",
              full_name: "Phường Hàng Đão",
              district_code: 2,
            },
            {
              code: 52,
              name: "Hàng Bồ",
              full_name: "Phường Hàng Bồ",
              district_code: 2,
            },
            {
              code: 55,
            ...
            },
            {
              code: 64,
              name: "Hàng Gai",
              full_name: "Phường Hàng Gai",
              district_code: 2,
            },
            {
              code: 67,
              name: "Chương Dương Độ",
              full_name: "Phường Chương Dương Độ",
              district_code: 2,
            },
            {
              code: 70,
              name: "Hàng Trống",
              full_name: "Phường Hàng Trống",
              district_code: 2,
            },
            {
              code: 73,
            ...
            },
            {
              code: 76,
              name: "Hàng Bông",
              full_name: "Phường Hàng Bông",
              district_code: 2,
            },
            {
              code: 79,
              name: "Tràng Tiền",
              full_name: "Phường Tràng Tiền",
              district_code: 2,
            },
            {
              code: 82,
            ...
            },
            {
              code: 85,
              name: "Phan Chu Trinh",
              full_name: "Phường Phan Chu Trinh",
              district_code: 2,
            },
            {
              code: 88,
              name: "Hàng Bài",
              full_name: "Phường Hàng Bài",
              district_code: 2,
            },
          ],
          760: [
            ...
            },
            {
              code: 26755,
              name: "Cô Giang",
              full_name: "Phường Cô Giang",
              district_code: 760,
            },
            {
              code: 26758,
              name: "Nguyễn Cư Trinh",
              full_name: "Phường Nguyễn Cư Trinh",
              district_code: 760,
            },
            {
              code: 26761,
              name: "Cầu Kho",
              full_name: "Phường Cầu Kho",
              district_code: 760,
            },
          ],
        };
